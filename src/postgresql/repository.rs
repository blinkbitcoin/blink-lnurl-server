...
/// NOTHING` is what makes two simultaneous first requests safe: the loser sees
/// the row it lost to and proceeds as a plain update instead of erroring.
    ...
    async fn upsert_spark_mode(
        ...
        let updated = sqlx::query(
            "UPDATE spark_accounts
             ...
             ,   country_source = CASE WHEN $7::boolean THEN $9::text ELSE country_source END
             ,   country_updated_at = CASE WHEN $7::boolean THEN $10::bigint ELSE country_updated_at END
             ,   updated_at = $5
             WHERE pubkey = $1
